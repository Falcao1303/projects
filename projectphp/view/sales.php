...
<div class="container" style='margin-left:200px;' ng-controller = "salesController" >
  <main >
    <div class="py-5 text-center">
      ...
      <p class="lead">Registre suas vendas abaixo</p>
    </div>
        ...
        <form class="needs-validation" novalidate>
          <div class="row g-3 justify-content-center">
            <div class="col-2" style="width:10%">
              <label for="product" class="form-label">Id de Venda</label>
              <input type="text" class="form-control" ng-model="saleCartModel.id_sale" id="sale_id" ng-blur="disableInput();" placeholder="Código" value="" required>
            </div>
            <div class="col-2" style="margin-left:30px; width:30%">
              <label for="price" class="form-label">Produto</label>
            ...
            <div class="col-1" >
              <label for="email" class="form-label">Adicionar ao carrinho</label>
          ...
          <div class="row g-3 justify-content-center" style="margin-top:10px">
            <h2>Cart</h2>
            <p  ng-if="productsCart.length == null">O carrinho está vazio</p>
            <table ng-if="productsCart.length > 0"class="table table-striped">
                        <thead>
                        <tr>
                          <th class="text-center" scope="col">Id venda</th>
          ...
          <div class="row g-2 justify-content-center">
              <button  ng-hide="edit"class="col-md-2 btn btn-primary btn-md" ng-click="saveTheSale()" type="submit">Finalizar Venda</button>
          </div>  
    ...
    <table class="table table-striped">
          ...
          <tr>
            <th class="text-center" scope="col">Id Venda</th>
            <th class="text-center" scope="col">Quantidade (un)</th>
